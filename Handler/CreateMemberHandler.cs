...
{
	public class CreateMemberHandler : IRequestHandler<CreateMemberRequest, ApiResponse>
	{
		...
		public async Task<ApiResponse> Handle(CreateMemberRequest request, CancellationToken cancellationToken)
		{
			try
			{
